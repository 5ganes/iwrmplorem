<?
	...
	if(isset($_POST['post']))
	{
		...
		$publish="No";
		$groups->savePost($comment, $postid, $userid, $publish);	
            ...
            <div class="container">
                <div class="row">
                    <div class="span9">
                        ...
                        <h2>Forum Posts<? if(isset($_GET['id'])){ echo " / ".$postGet['name'];}?></h2>
                    </div>
                    <div class="span3">
        ...
        <div class="services-full-width container">
            <div class="row">
                <div class="services-full-width-text span12">
                    	...
                    	<div>
							...
							{?>
                            	<ul>
									...
									{?>
										<li>
                                        	<p style="color:#00C; font-size:18px; margin-bottom:0">
                                            <?
                                            	$comntr=$users->getUserById($comGet['userid']);
												echo $comntr['name'].", ".$comGet['onDate'];
											?>
                                           	</p>
                                            <p style="color:#F00; font-size:16px; width:80%">
												<?=$comGet['comment'];?>
                                           	</p>
                                        </li>
									<? }
                    ...
                    <? if($_GET['id']){?><br /><h4>Other Posts</h4><? }?>
                    <ul class="list">
                        ...
                        {?>
                            <li style="font-size:19px; list-style:none; margin:10px 0">
                            	<a href="forum.php/<?=$forumGet['id'];?>"><?=$forumGet['name'];?></a>
                          	</li>
                        <? }?>
                    </ul>
                </div>
